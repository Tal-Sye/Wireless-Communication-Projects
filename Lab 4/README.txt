...
and receiver applies coherent detection. Under the deterministic or fixed waveform
technology, the transmitter does not change its waveform S from one transmission to
another.
...
2. imulate the instantaneous BER expression and plot average BERs
to verify your above system simulation results.
